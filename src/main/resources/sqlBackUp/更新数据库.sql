...
MySQL Backup
Database: ms_blog
Backup Time: 2021-05-31 09:39:22
*/
...
INSERT INTO `ms_blog`.`ms_user` (`id`,`username`,`pwd`,`email`,`phone`,`create_time`,`update_time`,`version`,`deleted`) VALUES (1, 'admin', '21232f297a57a5a743894a0e4a801fc3', '36119345@qq.com', 1775309269, '2021-05-20 17:47:14', '2021-05-20 17:47:14', 0, 0),(2, 'admin', 'admin', NULL, NULL, NULL, NULL, 1, NULL),(12, 'text2', '2222', NULL, NULL, NULL, NULL, 1, NULL),(1392752115447533570, '11131', '131', '123@qq.com', 0, '2021-05-13 16:02:35', '2021-05-13 17:39:15', 3, 0),(1393106891279986689, 'text1', '133', NULL, 1000001, '2021-05-14 15:32:20', '2021-05-14 15:32:20', 0, 0),(1393111612233474050, '12312', '29852fd8f42d63ef579aa46d8cd15183', NULL, 312331, '2021-05-14 15:51:06', '2021-05-14 15:51:06', 0, 0),(1393130419668688898, 'ms', '21232f297a57a5a743894a0e4a801fc3', NULL, NULL, '2021-05-14 17:05:50', '2021-05-14 17:05:50', 0, 0);
UNLOCK TABLES;
COMMIT;
BEGIN;
LOCK TABLES `ms_blog`.`ms_user_role` WRITE;
DELETE FROM `ms_blog`.`ms_user_role`;
INSERT INTO `ms_blog`.`ms_user_role` (`id`,`uid`,`rid`) VALUES (1, 1, 1),(2, 1, 2),(3, 1, 3),(4, 1393130419668688898, 3);
UNLOCK TABLES;
COMMIT;
